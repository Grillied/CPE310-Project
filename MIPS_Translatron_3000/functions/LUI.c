...
* Added comments
* Fixed parameter checks--deleted check for source register
* Fixed bit assignments -- imaginary source register always
  set to "00000"
* In dissassembler, added a check to determine if imaginary source
   register is set to "00000"
* Removed imaginary source register's value determination
* Removed imaginary source register's parameter set
*/
...
void lui_immd_bin(void) {
	...
	//added check to make sure imaginary source register is always set to
	//"00000"
